...
<div class="gate-modal" id="gate-modal" hidden>
  ...
  <div class="gate-box" role="dialog" aria-modal="true" aria-labelledby="gate-title">
    ...
    <form id="download-gate"><label for="gate-email">Email address</label><input id="gate-email" name="email" type="email" required autocomplete="email" placeholder="you@example.com"><input id="gate-item" name="item" type="hidden"><label class="consent"><input id="gate-marketing" type="checkbox" checked> Send me new mixes, DJ school updates, discounts and event news.</label><button class="bt bp" type="submit">Unlock download &rarr;</button><p class="gate-status" id="gate-status" aria-live="polite"></p></form>
